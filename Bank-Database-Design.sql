...
--Creating a database for a banking application called 'Bank'. 

create database dbBankM;
GO
...
-- Inserting at least 5 rows in each table. 
/** INSERT rows section **/
...
--Now Creating a view to get all customers with checking account from ON province. 
...
-- Creating a view to get all customers with total account balance (including interest rate) greater than 5000. 
...
-- Creating a view to get counts of checking and savings accounts by customer. 
...
-- Creating a view to get any particular user's login and password using AccountId. 
...
-- Creating a view to get all customers overdraft amount. 
...
-- Creating a stored procedure to add "User_" as a prefix to everyone's login (username). 
...
-- Creating a stored procedure that takes a deposit as a parameter and updates CurrentBalance value for that particular account.  
...
-- Creating a stored procedure that takes a withdrawal amount as a parameter and updates CurrentBalance value for that particular account. 
...
-- Creating a stored procedure to remove all security questions for a particular login. 
...
-- Writting a query to remove SSN column from Customer table. 
